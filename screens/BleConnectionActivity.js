...
import {
  ...
  readMultiVote,
  readYesNoVote,
} from "../constants/BleServiceCharacteristics";
              ...
              BleManager.retrieveServices(peripheral.id).then(
                (peripheralInfo) => {
                  ...
                  if (ELECTION_TYPES[electionType] == "SingleChoiceVote") {
                    ...
                    ELECTION_TYPES[electionType] == "MultiChoiceVote"
                  ) {
                  ...
                  setTimeout(() => {
                    ...
                    BleManager.startNotification(
                      ...
                      .then(() => {
                        ...
                        BleManager.read(peripheral.id, service, readMultiVote)
                          .then((readData) => {
                            // get the length of the json data sent from the first read.
                            let json_string_len = parseInt(
                              ...
                              while (json_read_len < json_string_len) {
                                await BleManager.read(
                                  ...
                                  .then((readData) => {
                                    ...
                                    json_string += String.fromCharCode.apply(
                                      null,
                                      readData
                                    );
                                    json_read_len += 20;
      ...
      <TouchableHighlight onPress={() => testPeripheral(item)}>
        <View style={[styles.row, { backgroundColor: color }]}>
          ...
          {item.connected && (
            <Fragment>
              <Button
                title="Press Me to See UUID info"
                onPress={() => {
                        ...
                        BleManager.startNotification(
                          ...
                          setTimeout(() => {
                            ...
                            BleManager.write(
                              ...
                              console.log(
                                `msg sent ${stringToBytes(text_to_send)}`
                              );
                            });
